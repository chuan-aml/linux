...
static const struct meson_msr_id clk_msr_a4_changed[] = {
...
static const struct meson_msr_id clk_msr_s7d_changed[] = {
...
static const struct meson_msr_id clk_msr_s6_changed[] = {
	CLK_MSR_ID(3, "dspa"),
...
static struct meson_msr_id clk_msr_a9[] = {
	...
	CLK_MSR_ID(216, "o_earcrx_dmdc_clk"),
	CLK_MSR_ID(217, "o_earcrx_cmdc_clk"),
	CLK_MSR_ID(218, "o_earctx_dmdc_clk"),
...
static const struct meson_msr_data clk_msr_a4_data = {
	.parent = (void *)&clk_msr_a5_data,
	.msr_table = (void *)clk_msr_a4_changed,
	.msr_count = ARRAY_SIZE(clk_msr_a4_changed),
	.reg = &msr_reg_offset_v2,
};
...
static const struct meson_msr_data clk_msr_s7d_data = {
	.parent = (void *)&clk_msr_s7_data,
	.msr_table = (void *)clk_msr_s7d_changed,
	.msr_count = ARRAY_SIZE(clk_msr_s7d_changed),
	.reg = &msr_reg_offset_v2,
};

static const struct meson_msr_data clk_msr_s6_data = {
	.parent = (void *)&clk_msr_s7d_data,
	.msr_table = (void *)clk_msr_s6_changed,
	.msr_count = ARRAY_SIZE(clk_msr_s6_changed),
	.reg = &msr_reg_offset_v2,
};
